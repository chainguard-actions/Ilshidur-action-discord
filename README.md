...
* Version : `uses: "Ilshidur/action-discord@0.4.0"` (&rarr; link to the releases list : https://github.com/Ilshidur/action-discord/releases)
* Commit SHA-1 : `uses: "Ilshidur/action-discord@ad5235de713df3ef38022185499b02ffe93b7efe"` (&rarr; link to the commits list : https://github.com/Ilshidur/action-discord/commits/master)
